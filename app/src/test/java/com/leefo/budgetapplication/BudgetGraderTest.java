...
public class BudgetGraderTest {
    ...
    @Test
    public void canGetBudgetCategoriesForMonth() {
        ...
        ArrayList<Category> testList = budgetGrader.getBudgetCategoriesByMonth(
                new TransactionRequest(null, 5, 2020));

        //Testlist must only contain testCat1 as this is the category with budget And transactions made.
    ...
    public void canGetAverageGrade() {
        ...
        FinancialTransaction testTransaction2 = new FinancialTransaction(30, "Test",
                LocalDate.of(2020, 5, 20), testCat1); // budget outcome = 30 / 20 = 1.5 = grade 1
